...
BranchName.grid(row=4, column = 2)
RegestrationNo.grid(row=5, column = 2)
...
BranchNameentry.grid(row=4, column=3,pady=5)
RegestrationNoentry.grid(row=5, column=3,pady=5)
